...
You may not redistribute, sell, sublicense, publish, or make Statamic
Secretary available as a standalone product, addon, service, or source-code
package. You may not remove copyright or licensing notices, or use substantial
parts of the software to create a competing addon or product.

These restrictions do not limit rights that cannot lawfully be excluded.

## Hosted service

The addon license does not include the optional hosted
`secretary@statamic.no` email service, OpenAI usage, Postmark usage, or a
Statamic license. The hosted email service is offered separately under its
own subscription and service terms.
...
Purchase, renewal, validation, and attachment of licenses are also subject to
the applicable Statamic Marketplace terms.
